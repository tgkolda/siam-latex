...
acceptable format, but SIAM also now allows JPEG and PNG. Please be
sure to produce high-resolution images.
%
...
\begin{figure}[tbhp]  \centering
  \begin{tikzpicture}[thick, >=stealth', dot/.style = {draw,fill = white,
      circle, inner sep = 0pt, minimum size = 4pt}]
    \coordinate (O) at (0,0);
...
\item Includes \texttt{amsmath}, \texttt{cleveref}, \texttt{hyperef},
  and \texttt{ntheorem}, \texttt{xr-hyperef}, \texttt{ifpdf}, \texttt{xcolor} packages by default.
